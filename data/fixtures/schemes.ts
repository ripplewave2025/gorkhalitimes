...
export const govtSchemes: GovtScheme[] = [
    {
        ...
        documentsNeeded: [
            { en: 'Identity proof', ne: 'परिचयपत्र' },
            { en: 'Bank passbook', ne: 'बैंक पासबुक' },
            { en: 'Tea garden work slip', ne: 'चिया बगानको काम विवरण' },
        ],
    ...
    },
    {
        ...
        documentsNeeded: [
            { en: 'Student ID', ne: 'विद्यार्थी परिचयपत्र' },
            { en: 'Bank account details', ne: 'बैंक खाता विवरण' },
            { en: 'Income certificate', ne: 'आय प्रमाणपत्र' },
        ],
    ...
    },
    {
        ...
        documentsNeeded: [
            { en: 'Local registration proof', ne: 'स्थानीय दर्ता प्रमाण' },
            { en: 'Land or work record', ne: 'जमिन वा कामको अभिलेख' },
            { en: 'Weather loss photos', ne: 'मौसम क्षतिको फोटो' },
        ],
